...
def menu(my_name,my_id):
	...
	print(f'{m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★\n{h}Selamat Datang{u} %s {k}SI ANAK HARAM'%(my_name)) 
	popen_xd(f'{u}ID  : '+str(my_id))
	popen_xd(f'{h}IP  : {ip}')
	popen_xd(f'{m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★\n{m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★  {m}★  {k}★  {h}★  {u}★  {b}★') 
